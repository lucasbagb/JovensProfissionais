...
/**
 * A classe <code>Carro</code> � uma classe p�blica e possui
 * <code>Override</code> do m�todo {@link #toString()}, para transcri��o de seus
...
public class Carro {
	...
	/**
	 * Vari�vel financeira de estabelecimento de margem de lucro da empresa na
	...
	/**
	 * Determina o valor de revenda do ve�culo com base na {@link #margemLucro}.
	 * 
	 * @param precoCompra
	 */
